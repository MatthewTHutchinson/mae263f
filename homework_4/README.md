...
If you add raw figure files (PNGs/PDFs) generated by the script, you may want to place them in a subdirectory such as:

- `figures/` – all plots used in the report (time-history, force-displacement curves, diameter sweep, etc.).
